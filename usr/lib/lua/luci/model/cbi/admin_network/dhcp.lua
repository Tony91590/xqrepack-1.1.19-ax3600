...
local a=luci.util.checklib("/usr/sbin/dnsmasq","libhogweed.so")
if a then
e=s:taboption("advanced",Flag,"dnssec",
translate("DNSSEC"))
e.optional=true
e=s:taboption("advanced",Flag,"dnsseccheckunsigned",
...
name.rmempty=true
function name.write(a,e,t)
Value.write(a,e,t)
m:set(e,"dns","1")
end
function name.remove(t,e)
Value.remove(t,e)
m:del(e,"dns")
end
...
t.neighbors({family=4},function(e)
if e.mac and e.dest then
ip:value(e.dest:string())
mac:value(e.mac,"%s (%s)"%{e.mac,e.dest:string()})
end
end)
function ip.validate(a,t,e)
local o=mac:formvalue(e)or""
local i=name:formvalue(e)or""
if t and#i==0 and#o==0 then
return nil,translate("One of hostname or mac address must be specified!")
end
return Value.validate(a,t,e)
end
